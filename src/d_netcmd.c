...
static CV_PossibleValue_t kartspeedostyle_cons_t[] = {{0, "Old"}, {1, "\"New\""}, {0, NULL}};
consvar_t cv_speedometerstyle = {"kartspeedstyle", "Old", CV_SAVE, kartspeedostyle_cons_t, NULL, 0, NULL, NULL, 0, 0, NULL};
