...
static CV_PossibleValue_t kartinvinmus_cons_t[] = {{0, "Noo"}, {1, "Yes"}, {0, NULL}};
consvar_t cv_kartinvinsfx = {"kartinvinsfx", "SFX", CV_SAVE, kartinvinsfx_cons_t, NULL, 0, NULL, NULL, 0, 0, NULL};
consvar_t cv_kartinvinmus = {"powerupmusic", "Yes", CV_SAVE, kartinvinmus_cons_t, NULL, 0, NULL, NULL, 0, 0, NULL};
consvar_t cv_kartfinallap = {"finalspeedup", "Noo", CV_SAVE, kartinvinmus_cons_t, NULL, 0, NULL, NULL, 0, 0, NULL};
